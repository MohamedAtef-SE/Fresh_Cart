...
export default function SpecBrand() {
    ...
    async function getSpecBrand() {
        ...
        return await axios.get(`https://ecommerce.routemisr.com/api/v1/products/?brand=${id}`)
    }
    ...
    return <section className="specBrand p-5 min-vh-100">
